...
exports.deleteUserContactController = void 0;
...
function deleteUserContactController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const contactToDelete = yield contactService.getUserContactById(id);
            if (!contactToDelete)
                throw new ResourceNotFoundException_1.ResourceNotFoundException(`Contact with ID ${id} doesn't exist.`);
            yield contactService.deleteUserContact(id);
...
exports.deleteUserContactController = deleteUserContactController;
//# sourceMappingURL=deleteUserContactController.js.map