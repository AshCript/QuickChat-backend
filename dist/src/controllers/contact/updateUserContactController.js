...
exports.updateUserContactController = void 0;
...
function updateUserContactController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!req.body.idUser || !req.body.idFriend)
                throw new ResourceNotFoundException_1.ResourceNotFoundException('You must provide idUser and idFriend properties.');
            const oldContact = yield contactService.getUserContactById(id);
            if (!oldContact)
                throw new ResourceNotFoundException_1.ResourceNotFoundException(`Contact with ID ${id} doesn't exist.`);
            const newContact = yield contactService.updateUserContact(id, req.body);
...
exports.updateUserContactController = updateUserContactController;
//# sourceMappingURL=updateUserContactController.js.map